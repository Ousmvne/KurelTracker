  ...
  return (
    <div className="p-5 pb-20 lg:p-8 lg:pb-8 lg:max-w-2xl">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-4 mb-5">
        <h3 className="text-[13px] font-bold text-gray-400 uppercase tracking-wider m-0 mb-3">Résumé du Kurél</h3>
        ...
        {group?.created_at && (
          <div className="text-[11px] text-gray-400 text-center mt-3 pt-3 border-t border-gray-100">
            Kurél créé le {fmtDate(group.created_at.slice(0, 10))}
          </div>
        )}
      </div>
      ...
      {/* Group settings */}
      <div className="bg-white border border-gray-200 rounded-2xl p-4 mb-5">
        <h3 className="text-[13px] font-bold text-gray-400 uppercase tracking-wider m-0 mb-3">Informations du Kurél</h3>

        <div className="mb-4">
          <label className="text-[13px] font-semibold text-gray-700 mb-1 block">Nom du Kurél</label>
          <input
      ...
      <div className="text-center text-[11px] text-gray-400 mt-6">
        ...
        <p className="m-0 mt-1">Suivi de répétitions pour Kurél</p>
      </div>
